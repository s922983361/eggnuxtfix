<template>
    <footer class="relative bg-gray-300 pt-8 pb-6">
        ...
        </div><!-- End SVG backgroung -->
        
        <!-- start main -->
        <div class="container mx-auto px-4">
            <div class="flex flex-wrap">
                <!-- start main left Item -->
                ...
                </div><!-- End main left Item -->
                <!-- start main right Item -->
                <div class="w-full lg:w-6/12 px-4">
                    <div class="flex flex-wrap items-top mb-6">
                        <!-- start main right Item Link 1 -->
                        ...
                        </div><!-- End main right Item Link 1-->
                        <!-- start main right Item Link 2-->
                        ...
                        </div><!-- End main right Item Link 2-->
                    </div>
                </div><!-- End main left Item -->
            </div>
